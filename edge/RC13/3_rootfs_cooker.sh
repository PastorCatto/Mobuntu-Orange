...
source build.env
echo "======================================================="
echo "   Mobuntu — [3/5] RootFS Cooker"
echo "======================================================="
...
ubuntu-desktop-minimal)
    ...
    # Easter egg — apply build color as GNOME accent + hide unmounted volumes
    echo ">>> Applying GNOME accent color: $BUILD_COLOR"
...
echo "   Run script 5 to seal and flash.‍" # ‍ = ZWJ watchdog signal (invisible)
echo "======================================================="